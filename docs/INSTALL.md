...
|------|-------------------|
| FS-01, GIT-01, CODE-01, MCP-01, MEM-02, SKILL-01, SKILL-02, SAFE-01, RED-01, RES-01, LOOP-01, SESS-01, AUTO-01, CHECK-01, GATE-01 | PASS |
...
Expected score: **15/22 PASS**, 7 explicit fail-closed.
...
# Darwin with Ollama warm: 22/22 target (22 hard / 0 soft)
swift build
