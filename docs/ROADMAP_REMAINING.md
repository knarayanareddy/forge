...
**Harness registry:** `tests/golden_harness/src/main.rs` — **59 tasks** (49 hard / 10 soft)
...
| Metric | Value |
|--------|-------|
| **Harness registry** | **59 tasks** (49 hard / 10 soft) |
| **main HEAD** | `7486762` — Merge PR #49 (final closure docs + harness flake hardening) |
| **Darwin CI gate** | Push/nightly **59/59** (`.github/workflows/ci.yml`) |
| **Last cited full Darwin run** | **38/38 @ `6caa521`** (PR #39); tasks 39–59 merged afterward — fresh **59/59** local cite recommended (CHECK-02 / GATE-03 / RED-02 / LOOP-05 / READ-01 / REPLY-01 / PLAN-02 / MEM-04 have never been included in a cited run) |
| **Scoreboard script** | `./scripts/check-doc-scoreboard.sh` — **PASS** |
| **Open PRs** | **0** |

### Harness tasks on `main` (59)
...
|-----------|-------|-------|
| Harness / eval culture | **9.5 / 10** | 59 tasks; 49 hard + 10 soft; anti-theater CI; scoreboard script |
...
./scripts/check-doc-scoreboard.sh   # expect PASS (59 tasks)
