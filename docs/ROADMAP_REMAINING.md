...
**Harness registry:** `tests/golden_harness/src/main.rs` — **57 tasks** (47 hard / 10 soft)
...
| Metric | Value |
|--------|-------|
| **Harness registry** | **57 tasks** (47 hard / 10 soft) |
| **main HEAD** | `7486762` — Merge PR #49 (final closure docs + harness flake hardening) |
| **Darwin CI gate** | Push/nightly **57/57** (`.github/workflows/ci.yml`) |
| **Last cited full Darwin run** | **38/38 @ `6caa521`** (PR #39); tasks 39–57 merged afterward — fresh **57/57** local cite recommended (CHECK-02 / GATE-03 / RED-02 / LOOP-05 / READ-01 / REPLY-01 have never been included in a cited run) |
| **Scoreboard script** | `./scripts/check-doc-scoreboard.sh` — **PASS** |
| **Open PRs** | **0** |

### Harness tasks on `main` (57)
...
|-----------|-------|-------|
| Harness / eval culture | **9.5 / 10** | 57 tasks; 47 hard + 10 soft; anti-theater CI; scoreboard script |
...
./scripts/check-doc-scoreboard.sh   # expect PASS (57 tasks)
