...
| Linux (default CI) | **45/58** | 34 hard / 11 soft† | LOOP-05, READ-01, REPLY-01 and PLAN-02 are deterministic, so they pass off Darwin. Last *measured* Linux run: `34719890944` (PR #52, `ubuntu-24.04`) at **44/57** (33 hard / 11 soft) — LOOP-05, READ-01 and REPLY-01 all **PASS [hard]**, and SUB-01 recovered to **PASS [hard]** after `preview_budget` started deriving the quote length from the file count (the P1-6 marker had lengthened every distilled line until the last file's name fell off the 2 000-char cap). PLAN-02 is not yet measured. FS-02, SB-01, MEM-01, ROUT-01, GRAPH-01, LOOP-02, PLAN-01, LOOP-04, INGEST-01, GRAPH-02, DIST-01 fail-closed; MCP-01/MCP-02 fail the entry-script hash pin\* |
