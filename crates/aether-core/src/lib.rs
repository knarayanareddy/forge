...
pub use keychain::{
    ...
    load_gateway_token, load_named_secret, require_byok_key_if_configured, store_byok_key,
    store_daemon_auth_token, store_gateway_token, store_named_secret, verify_daemon_auth_token,
